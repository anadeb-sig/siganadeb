...
class PermissionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('permissions.index')->with('success_message','Permission créée avec succès.');
        } catch (\Throwable $th) {
            DB::rollback();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('permissions.index')->with('success_message','Permissions modifiée avec succès.');
        } catch (\Throwable $th) {
            DB::rollback();
    ...
    public function destroy(Permission $permission)
    {
        try {
            ...
            return redirect()->route('permissions.index')
                ->with('success_message', 'La permission a été supprimée avec succès.');
