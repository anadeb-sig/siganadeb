...
window.addEventListener('DOMContentLoaded', event => {
    ...
    if (window.innerWidth >= BOOTSTRAP_LG_WIDTH) {
        document.body.classList.add('nav-fixed', 'sidenav-toggled');
    } else {
        document.body.classList.add('nav-fixed');
        document.body.classList.remove('sidenav-toggled');
    }

    // Handle resize event to toggle classes based on screen size
    ...
    if (sidebarToggle) {
        sidebarToggle.addEventListener('click', event => {
            event.preventDefault();
            // Toggle 'sidenav-toggled' class based on current state
            if (window.innerWidth < BOOTSTRAP_LG_WIDTH) {
                document.body.classList.toggle('sidenav-toggled');
            } else {
                document.body.classList.toggle('sidenav-toggled');
