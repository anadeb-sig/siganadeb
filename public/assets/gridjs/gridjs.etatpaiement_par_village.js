function rendtableau_paiement_village(nom_reg, nom_pref, nom_comm, nom_cant, nom_vill, financement) {
    fetch(`/fsb_syntheses/fetch?nom_reg=${nom_reg}&nom_pref=${nom_pref}&nom_comm=${nom_comm}&nom_cant=${nom_cant}&nom_vill=${nom_vill}&financement=${financement}`)
