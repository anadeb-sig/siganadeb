    ...
    <div class="row">
        <div class="col-lg-3 mb-4">
            ...
            <div class="card mb-4">
                ...
                <div class="list-group list-group-flush small">
                    ...
                    <a class="list-group-item list-group-item-action" href="#!">
                        Date signature : {{ $demande->date_sign }}
                    </a>
                    <a class="list-group-item list-group-item-action" href="#!">
                        Date demarrage des travaux : {{ $demande->date_debut }}
                    </a>
                    <a class="list-group-item list-group-item-action" href="#!">
                        Date fin des travaux : {{ $demande->date_fin }}
                    </a>
                </div>
                <div class="card-header">Information sur l'entreprise'</div>
                <div class="list-group list-group-flush small">
                    <a class="list-group-item list-group-item-action" href="#!">
                        Entreprise : {{ $demande->nom_entrep }}
                    </a>
                    <a class="list-group-item list-group-item-action" href="#!">
                        Numro NIF : {{ $demande->num_id_f }}
                    </a>
                    <a class="list-group-item list-group-item-action" href="#!">
                        Nom du charger : {{ $demande->nom_charge }}   {{ $demande->prenom_charge }}
                    </a>
                    <a class="list-group-item list-group-item-action" href="#!">
                        Email : {{ $demande->email }}
                    </a>
                    <a class="list-group-item list-group-item-action" href="#!">
                        Tléphone : {{ $demande->tel }}
                    </a>
                    <a class="list-group-item list-group-item-action" href="#!">
                        Adresse : {{ $demande->addr }}
                    </a>
                </div>
        ...
        <div class="col-lg-9 mb-4">
            ...
            <div class="card invoice">
                <div class="card-header">Inormations sur la demande d'augmentation de jour de travail</div>
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href='/demandejours/approvals/{{ $demande->id }}/Approuvé/{{ $demande->date_fin }}'>
                            ...
                            <tfoot>
                                <tr>
                                    <td class="text-left">
                                        <a class="" href="{{ Route('demandejours.index') }}">
