    ...
    <div class="card">
        <div class="card-header border-bottom">
            ...
            <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                ...
                @if ($user->hasRole('Infra') || $user->hasAnyRole($generalRoles))
                    ...
                    <a class="nav-item nav-link" id="wizard4-tab" href="#wizard4" data-bs-toggle="tab" role="tab" aria-controls="wizard4" aria-selected="true">
                        ...
                        <div class="wizard-step-text">
                            <div class="wizard-step-text-details">Infrastructures</div>
                        </div>
                    </a>
                @endif
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7"><div class="row search_output">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 d-flex region">
                                        <select type="text" class="form-control w-100"  value="">
                                            <option value="">Recherchez par région</option>
                                            <option value="CENTRALE">CENTRALE</option>
                                            <option value="KARA">KARA</option>
                                            <option value="MARITIME">MARITIME</option>
                        ...
                        <div class="row mt-4 mb-4">
                            <div class="col-xl-4">
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        <h5 type="text" class="card-title text-center h2  fw-bold" id=""></h5>
                                        <p class="card-text text-center"></p>
                                    </div>
                                </div>
                            </div>                
                            <div class="col-xl-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title text-center h2  fw-bold" id=""></h5>
                                        <p class="card-text text-center"></p>
                                    </div>
                                </div>
                            </div>
