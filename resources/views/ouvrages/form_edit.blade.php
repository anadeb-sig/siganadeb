...
<div class="row  mt-4">
    <div class="col-md-3 {{ $errors->has('typeouvrage_id') ? 'has-error' : '' }}">
    ...
    <div class="col-md-3 {{ $errors->has('nom_ouvrage') ? 'has-error' : '' }}">
    ...
    <div class="col-xl-3 {{ $errors->has('financement_id') ? 'has-error' : '' }}">
    ...
    <div class="col-md-3 {{ $errors->has('projet_id') ? 'has-error' : '' }}">
