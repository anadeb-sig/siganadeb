    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 {{ $errors->has('nom_site') ? 'has-error' : '' }}">
                ...
                <input class="form-control majuscules nom_site" name="nom_site" type="text" id="nom_site" value="" min="0" max="150" placeholder="{{ __('Entrer le nom du site') }}">
            ...
            <div class="col-md-6 {{ $errors->has('budget') ? 'has-error' : '' }}">
                ...
                <input class="form-control budget" name="budget" type="number" id="budget" value="" placeholder="{{ __('Entrer un montant') }}">
        ...
        <div class="row mt-3">
            <div class="col-md-12 {{ $errors->has('descrip') ? 'has-error' : '' }}">
                ...
                <textarea class="form-control majuscules descrip_site" name="descrip_site" type="text" id="descrip_site" rows="5" value="" maxlength="250" placeholder="{{ __('Entrer la description') }}"></textarea>
