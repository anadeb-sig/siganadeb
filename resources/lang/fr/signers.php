...
return [
    ...
    'contrat_id' => 'Contrat',
    'contrat_id__placeholder' => 'Select contrat',
    'ouvrage_id' => 'Ouvrage',
    'ouvrage_id__placeholder' => 'Enter ouvrage here...',
    'entreprise_id' => 'Entreprise',
    'entreprise_id__placeholder' => 'Select entreprise',
    'date_sign' => 'Date Sign',
    'date_sign__placeholder' => 'Enter date sign here...',
    ...
    'index_route_description' => 'Retrieve existing signers.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the signer property name where the value is the assigned value to the retrieved signer.',
    ...
    'show_route_description' => 'Retrieve existsing signer.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the signer to retrieve',
    'destroy_route_description' => 'Delete existsing signer.',
    ...
    'the_id_of_model_to_delete' => 'The id of the signer to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete signers.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the signer.',
    ...
    'the_requested_model_does_not_exists' => 'The requested signer does not exists.',
    ...
    'create' => 'Create New Signer',
    'delete' => 'Delete Signer',
    'edit' => 'Edit Signer',
    'show' => 'Show Signer',
    'show_all' => 'Show All Signer',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Signer.',
    'none_available' => 'No Signers Available.',
    'model_plural' => 'Signers',
    'model_was_added' => 'Signer was successfully added.',
    'model_was_retrieved' => 'Signer was successfully retrieved.',
    'models_were_retrieved' => 'Signers were successfully retrieved.',
    'model_was_updated' => 'Signer was successfully updated.',
    'model_was_deleted' => 'Signer was successfully deleted.',
