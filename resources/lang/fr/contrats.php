...
return [
    ...
    'date_debut__placeholder' => 'Enter date debut here...',
    'date_fin' => 'Date Fin',
    'date_fin__placeholder' => 'Enter date fin here...',
    ...
    'index_route_description' => 'Retrieve existing contrats.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the contrat property name where the value is the assigned value to the retrieved contrat.',
    ...
    'show_route_description' => 'Retrieve existsing contrat.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the contrat to retrieve',
    'destroy_route_description' => 'Delete existsing contrat.',
    ...
    'the_id_of_model_to_delete' => 'The id of the contrat to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete contrats.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the contrat.',
    ...
    'the_requested_model_does_not_exists' => 'The requested contrat does not exists.',
    ...
    'create' => 'Create New Contrat',
    'delete' => 'Delete Contrat',
    'edit' => 'Edit Contrat',
    'show' => 'Show Contrat',
    'show_all' => 'Show All Contrat',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Contrat.',
    'none_available' => 'No Contrats Available.',
    'model_plural' => 'Contrats',
    'model_was_added' => 'Contrat was successfully added.',
    'model_was_retrieved' => 'Contrat was successfully retrieved.',
    'models_were_retrieved' => 'Contrats were successfully retrieved.',
    'model_was_updated' => 'Contrat was successfully updated.',
    'model_was_deleted' => 'Contrat was successfully deleted.',
