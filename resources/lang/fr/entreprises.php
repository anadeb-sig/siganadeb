...
return [
    ...
    'nom_entrep' => 'Nom Entrep',
    'nom_entrep__placeholder' => 'Enter nom entrep here...',
    'num_id_f' => 'Num',
    'num_id_f__placeholder' => 'Enter num here...',
    'nom_charge' => 'Nom Charge',
    'nom_charge__placeholder' => 'Enter nom charge here...',
    'prenom_charge' => 'Prenom Charge',
    'prenom_charge__placeholder' => 'Enter prenom charge here...',
    'tel' => 'Tel',
    'tel__placeholder' => 'Enter tel here...',
    'addr' => 'Addr',
    'addr__placeholder' => 'Enter addr here...',
    ...
    'index_route_description' => 'Retrieve existing entreprises.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the entreprise property name where the value is the assigned value to the retrieved entreprise.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved entreprise.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of entreprises per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved entreprise.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new entreprise.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing entreprise.',
    ...
    'show_route_description' => 'Retrieve existsing entreprise.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the entreprise to retrieve',
    'destroy_route_description' => 'Delete existsing entreprise.',
    ...
    'the_id_of_model_to_delete' => 'The id of the entreprise to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete entreprises.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the entreprise.',
    ...
    'the_requested_model_does_not_exists' => 'The requested entreprise does not exists.',
    ...
    'create' => 'Create New Entreprise',
    'delete' => 'Delete Entreprise',
    'edit' => 'Edit Entreprise',
    'show' => 'Show Entreprise',
    'show_all' => 'Show All Entreprise',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Entreprise.',
    'none_available' => 'No Entreprises Available.',
    'model_plural' => 'Entreprises',
    'model_was_added' => 'Entreprise was successfully added.',
    'model_was_retrieved' => 'Entreprise was successfully retrieved.',
    'models_were_retrieved' => 'Entreprises were successfully retrieved.',
    'model_was_updated' => 'Entreprise was successfully updated.',
    'model_was_deleted' => 'Entreprise was successfully deleted.',
    ...
    'model_id_camel_case' => 'entrepriseId',
