...
return [
    ...
    'nom_ouvrage' => 'Nom Ouvrage',
    'nom_ouvrage__placeholder' => 'Enter nom ouvrage here...',
    'descrip' => 'Descrip',
    'descrip__placeholder' => 'Enter descrip here...',
    'village_id' => 'Village',
    'village_id__placeholder' => 'Enter village here...',
    'typeouvrage_id' => 'Typeouvrage',
    'typeouvrage_id__placeholder' => 'Enter typeouvrage here...',
    ...
    'index_route_description' => 'Retrieve existing ouvrages.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the ouvrage property name where the value is the assigned value to the retrieved ouvrage.',
    ...
    'show_route_description' => 'Retrieve existsing ouvrage.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the ouvrage to retrieve',
    'destroy_route_description' => 'Delete existsing ouvrage.',
    ...
    'the_id_of_model_to_delete' => 'The id of the ouvrage to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete ouvrages.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the ouvrage.',
    ...
    'the_requested_model_does_not_exists' => 'The requested ouvrage does not exists.',
    ...
    'create' => 'Create New Ouvrage',
    'delete' => 'Delete Ouvrage',
    'edit' => 'Edit Ouvrage',
    'show' => 'Show Ouvrage',
    'show_all' => 'Show All Ouvrage',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Ouvrage.',
    'none_available' => 'No Ouvrages Available.',
    'model_plural' => 'Ouvrages',
    'model_was_added' => 'Ouvrage was successfully added.',
    'model_was_retrieved' => 'Ouvrage was successfully retrieved.',
    'models_were_retrieved' => 'Ouvrages were successfully retrieved.',
    'model_was_updated' => 'Ouvrage was successfully updated.',
    'model_was_deleted' => 'Ouvrage was successfully deleted.',
