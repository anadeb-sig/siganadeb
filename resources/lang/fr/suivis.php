...
return [
    ...
    'photo_ouvrage' => 'Photo Ouvrage',
    'photo_ouvrage__placeholder' => 'Enter photo ouvrage here...',
    'conf_plan' => 'Conf Plan',
    'conf_plan__placeholder' => 'Enter conf plan here...',
    'conf_plan_oui' => 'Oui',
    'conf_plan_non' => 'Non',
    'date_suivi' => 'Date Suivi',
    'date_suivi__placeholder' => 'Enter date suivi here...',
    'signe_id' => 'Signe',
    'signe_id__placeholder' => 'Select signe',
    ...
    'index_route_description' => 'Retrieve existing suivis.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the suivi property name where the value is the assigned value to the retrieved suivi.',
    ...
    'show_route_description' => 'Retrieve existsing suivi.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the suivi to retrieve',
    'destroy_route_description' => 'Delete existsing suivi.',
    ...
    'the_id_of_model_to_delete' => 'The id of the suivi to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete suivis.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the suivi.',
    ...
    'the_requested_model_does_not_exists' => 'The requested suivi does not exists.',
    ...
    'create' => 'Create New Suivi',
    'delete' => 'Delete Suivi',
    'edit' => 'Edit Suivi',
    'show' => 'Show Suivi',
    'show_all' => 'Show All Suivi',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Suivi.',
    'none_available' => 'No Suivis Available.',
    'model_plural' => 'Suivis',
    'model_was_added' => 'Suivi was successfully added.',
    'model_was_retrieved' => 'Suivi was successfully retrieved.',
    'models_were_retrieved' => 'Suivis were successfully retrieved.',
    'model_was_updated' => 'Suivi was successfully updated.',
    'model_was_deleted' => 'Suivi was successfully deleted.',
