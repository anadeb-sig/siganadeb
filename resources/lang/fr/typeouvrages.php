...
return [
    ...
    'nom_type' => 'Nom Type',
    'nom_type__placeholder' => 'Enter nom type here...',
    ...
    'index_route_description' => 'Retrieve existing typeouvrages.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the typeouvrage property name where the value is the assigned value to the retrieved typeouvrage.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved typeouvrage.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of typeouvrages per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved typeouvrage.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new typeouvrage.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing typeouvrage.',
    ...
    'show_route_description' => 'Retrieve existsing typeouvrage.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the typeouvrage to retrieve',
    'destroy_route_description' => 'Delete existsing typeouvrage.',
    ...
    'the_id_of_model_to_delete' => 'The id of the typeouvrage to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete typeouvrages.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the typeouvrage.',
    ...
    'the_requested_model_does_not_exists' => 'The requested typeouvrage does not exists.',
    ...
    'create' => 'Create New Typeouvrage',
    'delete' => 'Delete Typeouvrage',
    'edit' => 'Edit Typeouvrage',
    'show' => 'Show Typeouvrage',
    'show_all' => 'Show All Typeouvrage',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Typeouvrage.',
    'none_available' => 'No Typeouvrages Available.',
    'model_plural' => 'Typeouvrages',
    'model_was_added' => 'Typeouvrage was successfully added.',
    'model_was_retrieved' => 'Typeouvrage was successfully retrieved.',
    'models_were_retrieved' => 'Typeouvrages were successfully retrieved.',
    'model_was_updated' => 'Typeouvrage was successfully updated.',
    'model_was_deleted' => 'Typeouvrage was successfully deleted.',
    ...
    'model_id_camel_case' => 'typeouvrageId',
